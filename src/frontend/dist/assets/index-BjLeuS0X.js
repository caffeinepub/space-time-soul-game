...
function AbilityButton({
  ...
  function handleTouchEnd() {
    ...
    setTimeout(() => setShowDesc(false), 2e3);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      type: "button",
      "data-ocid": `ability.button.${index2 + 1}`,
      className: `
        relative flex flex-col items-center justify-center gap-1
        min-h-[72px] px-2 py-2 rounded-xl border glass-panel
        transition-all duration-150
        ${isDisabled ? "opacity-40 cursor-not-allowed border-border" : "cursor-pointer active:scale-95 hover:scale-105"}
      `,
      style: !isDisabled ? {
      ...
      disabled: isDisabled,
      onClick: !isDisabled ? onUse : void 0,
      onTouchStart: handleTouchStart,
      onTouchEnd: handleTouchEnd,
      onMouseEnter: () => setShowDesc(true),
      onMouseLeave: () => setShowDesc(false),
      children: [
        onCooldown && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1 right-1 w-5 h-5 rounded-full bg-black/70 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-bold text-destructive", children: ability.cooldown }) }),
        showDesc && !onCooldown && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-xl bg-black/92 flex items-center justify-center z-10 p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-foreground text-center leading-tight", children: ability.desc }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl leading-none", children: ability.icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-display font-bold uppercase tracking-wide text-foreground leading-tight text-center", children: ability.name }),
        ability.maxCooldown > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-muted-foreground", children: onCooldown ? `CD: ${ability.cooldown}` : "Ready" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px]", style: { color: heroColor }, children: "No CD" })
      ]
    }
  );
}
...
function CharacterSprite(props) {
  if (props.type === "villain") {
    const { hp: hp2, isShaking: isShaking2, isActing } = props;
    const isDead2 = hp2 <= 0;
    let animClass2 = "anim-glow-villain anim-float-villain";
    if (isShaking2) animClass2 = "anim-shake anim-damage";
    if (isActing) animClass2 = "anim-glow-villain";
    if (isDead2) animClass2 = "";
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `relative w-20 h-28 ${animClass2} ${isDead2 ? "opacity-20 grayscale" : ""} transition-all duration-300`,
        children: [
          ...
          isActing && !isDead2 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "absolute inset-0 rounded-full pointer-events-none",
              style: {
                animation: "ability-burst 0.6s ease-out forwards",
                background: "radial-gradient(circle, oklch(0.66 0.25 330 / 0.6) 0%, transparent 70%)"
              }
            }
          )
        ]
  ...
  const isDead = hp <= 0;
  const glowAnimation = heroId === "space" ? "anim-glow-nova" : heroId === "time" ? "anim-glow-chronos" : "anim-glow-essence";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: `relative w-14 h-16 ${animClass} ${isDead ? "opacity-20 grayscale" : ""} transition-all duration-300`,
...
function HealthBar({ current, max, type, small }) {
  const pct = Math.max(0, Math.min(100, current / max * 100));
  let barStyle;
  if (type === "villain") {
    barStyle = {
      background: "linear-gradient(90deg, oklch(0.45 0.22 25), oklch(0.65 0.25 15))",
      boxShadow: "0 0 8px oklch(0.58 0.18 25 / 0.6)"
    };
  } else {
    if (pct > 50) {
      barStyle = {
        background: "linear-gradient(90deg, oklch(0.55 0.18 145), oklch(0.7 0.15 150))",
        boxShadow: "0 0 6px oklch(0.6 0.18 145 / 0.5)"
      };
    } else if (pct > 25) {
      barStyle = {
        background: "linear-gradient(90deg, oklch(0.65 0.18 65), oklch(0.75 0.2 75))",
        boxShadow: "0 0 6px oklch(0.65 0.18 65 / 0.5)"
      };
    } else {
      barStyle = {
        background: "linear-gradient(90deg, oklch(0.45 0.22 25), oklch(0.6 0.25 20))",
...
function BattleScreen({
  ...
  const isHeroTurn = state.phase === "hero_turn" && state.gameStatus === "playing";
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        state.warpFlash && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "fixed inset-0 z-50 pointer-events-none",
            style: {
              animation: "screen-flash 1.5s ease-out forwards",
              background: "radial-gradient(circle, oklch(0.66 0.25 330 / 0.8) 0%, oklch(0.56 0.22 290 / 0.4) 60%, transparent 100%)"
            }
          }
        ),
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground uppercase tracking-widest", children: "Turn" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-display font-black text-foreground leading-none", children: state.turn })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-xs font-display font-black uppercase tracking-widest text-foreground", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-nova", children: "SPACE" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: " · " }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#A855F7]", children: "TIME" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: " · " }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[#F5C542]", children: "SOUL" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: `text-[10px] font-bold uppercase tracking-wider mt-0.5 px-2 py-0.5 rounded-full ${isHeroTurn ? "bg-primary/20 text-primary border border-primary/40" : "bg-villain/20 text-villain border border-villain/40"}`,
                    children: isHeroTurn ? "⚔ YOUR TURN" : "👁 VILLAIN ACTS"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground uppercase tracking-widest", children: "Phase" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: `text-xs font-bold ${PHASE_COLORS[state.villain.phase]}`,
                    children: PHASE_LABELS[state.villain.phase].split(" · ")[0]
                  }
                )
              ] })
            ]
        ...
        state.warpMessage && state.warpFlash && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                CharacterSprite,
                {
                  type: "villain",
                  hp: state.villain.hp,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col justify-center gap-1.5 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-display font-black uppercase tracking-wider text-villain", children: "THE ARCHITECT" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: `text-[9px] font-bold px-1.5 py-0.5 rounded border ${state.villain.phase === 3 ? "border-destructive/60 text-destructive bg-destructive/10" : "border-villain/40 text-villain bg-villain/10"}`,
                      children: PHASE_LABELS[state.villain.phase]
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-[10px]", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
                    state.villain.stunned && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-[#A855F7]/20 text-[#A855F7] border border-[#A855F7]/40 rounded px-1.5 py-0.5 text-[9px] font-bold", children: "STUNNED" }),
                    state.villain.slowed && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-[#F5C542]/20 text-[#F5C542] border border-[#F5C542]/40 rounded px-1.5 py-0.5 text-[9px] font-bold", children: "SLOWED" })
                  ] })
                ] })
              ] })
            ]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: state.heroes.map((hero, idx) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  onClick: () => !isDead && isHeroTurn && dispatch({ type: "SELECT_HERO", index: idx }),
                  className: `
              ...
              `,
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(HealthBar, { current: hero.hp, max: hero.maxHp, type: "hp", small: true }),
                    isDead && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] text-destructive font-bold uppercase", children: "FALLEN" })
                  ]
                },
                hero.id
              );
        ...
        (statusEffects.heroShielded || statusEffects.heroDodging > 0) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-3 mt-1.5 flex gap-1.5", "data-ocid": "battle.panel", children: [
          statusEffects.heroShielded && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] bg-nova/15 text-nova border border-nova/30 rounded-full px-2 py-0.5 font-bold", children: "🛡 SHIELDED" }),
          statusEffects.heroDodging > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] bg-[#F5C542]/15 text-[#F5C542] border border-[#F5C542]/30 rounded-full px-2 py-0.5 font-bold", children: [
            "👻 DODGE ×",
            statusEffects.heroDodging
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            "data-ocid": "battle.panel",
            children: state.combatLog.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `text-[10px] leading-tight ${entry.type === "villain" ? "text-villain/90" : entry.type === "reality" ? "text-villain font-bold" : entry.type === "hero" ? "text-foreground/80" : "text-muted-foreground"}`,
                children: entry.text
              },
              entry.id
            ))
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-panel rounded-none border-t border-border/50 px-3 py-3 mt-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-1.5 mb-3", children: state.heroes.map((hero, idx) => {
            const isActive = state.activeHeroIndex === idx;
            const isDead = hero.hp <= 0;
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                disabled: isDead || !isHeroTurn,
                onClick: () => !isDead && isHeroTurn && dispatch({ type: "SELECT_HERO", index: idx }),
                className: `py-1.5 rounded-lg border font-display font-bold text-xs uppercase tracking-wide transition-all duration-150 ${isDead ? "opacity-30 border-border text-muted-foreground" : ""} ${!isDead && isHeroTurn ? "cursor-pointer active:scale-95" : ""}`,
                style: isActive && !isDead ? {
                  borderColor: hero.color,
                  color: hero.color,
          ...
          activeHero && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3 flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: activeHero.name
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground uppercase tracking-wide", children: activeHero.title })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-between text-[10px] mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
                activeHero.hp,
                " / ",
                activeHero.maxHp,
                " HP"
          ...
          activeHero && activeHero.hp > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", "data-ocid": "ability.panel", children: activeHero.abilities.map((ability, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            AbilityButton,
            {
              ability,
            ...
            "div",
            {
              ...
              children: [
                (activeHero == null ? void 0 : activeHero.name) ?? "This hero",
                " has fallen. Select another hero."
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "text-center py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-[10px]", children: [
          "© ",
...
const LORE_TEXT = "When The Architect — wielder of infinite Reality — threatens to unmake existence, three cosmic warriors answer the call. Astrid, master of Space; Chronos, keeper of Time; Seraphina, binder of Souls. United by fate, divided by the cosmos, they must fight as one to restore what was lost...";
const HEROES = [
  {
    id: "space",
    name: "Astrid",
...
function IntroScreen({ onStart }) {
  ...
  const [typewriterDone, setTypewriterDone] = reactExports.useState(false);
  reactExports.useEffect(() => {
    let i = 0;
    setDisplayedText("");
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs tracking-[0.3em] text-muted-foreground uppercase mb-2", children: "AN EPIC BATTLE FOR EXISTENCE" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "h1",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#38BDF8" }, children: "SPACE" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: " · " }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#A855F7" }, children: "TIME" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: " · " }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#F5C542" }, children: "SOUL" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-villain text-sm tracking-[0.2em] uppercase mt-1 font-semibold", children: "vs. THE ARCHITECT" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3 w-full mb-6", children: HEROES.map((hero, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-[10px] uppercase tracking-wide text-center", children: hero.title })
            ]
          },
          hero.id
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs tracking-[0.2em] text-primary uppercase mb-2 font-semibold", children: "◈ HERO ABILITIES" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2", children: [
              ...
              ].map((h) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                h.abilities.map((ab) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs tracking-[0.2em] text-primary uppercase mb-2 font-semibold", children: "◈ THE LORE" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-foreground/80 leading-relaxed min-h-[70px]", children: [
                displayedText,
                !typewriterDone && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block w-0.5 h-4 bg-primary ml-0.5 animate-pulse" })
              ] })
            ]
          }
        ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "mt-auto pt-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-[10px]", children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          ". Built with ♥ using",
          " ",
...
function Starfield() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "starfield", children: stars.map((star) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: "star",
      style: {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: isWin ? "radial-gradient(circle at 50% 40%, oklch(0.78 0.14 218 / 0.2) 0%, transparent 60%)" : "radial-gradient(circle at 50% 40%, oklch(0.58 0.18 25 / 0.3) 0%, transparent 60%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col items-center gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: { animationDelay: "0s" },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl mb-4", children: isWin ? "✦" : "☠" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h1",
                  {
                    className: `text-4xl font-display font-black uppercase tracking-[0.15em] ${isWin ? "text-nova anim-glow-title" : "text-destructive"}`,
                    children: isWin ? "REALITY" : "DARKNESS"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h1",
                  {
                    className: `text-4xl font-display font-black uppercase tracking-[0.15em] ${isWin ? "text-nova anim-glow-title" : "text-destructive"}`,
                    children: isWin ? "RESTORED" : "PREVAILS"
                  }
                )
              ]
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: isWin ? "The Architect falls. Astrid, Chronos, and Seraphina unite their powers — sealing the breach. The cosmos breathes again." : "The Architect's laughter echoes across shattered dimensions. Reality folds in on itself. All that was... unmade."
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground uppercase tracking-widest mb-3", children: "Battle Summary" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl font-display font-black text-primary", children: turns }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground uppercase tracking-widest", children: "Turns" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        style: { color: "#F5C542" },
                        children: abilitiesUsed
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground uppercase tracking-widest", children: "Abilities Used" })
                  ] })
                ] })
              ]
            }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: isWin ? "⚔ PLAY AGAIN" : "↺ TRY AGAIN"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "absolute bottom-6 left-0 right-0 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-[10px]", children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          ". Built with ♥ using",
          " ",
...
function addLog(state, text, type) {
  const entry = { id: state.logIdCounter, text, type };
  return {
    ...state,
...
function getVillainPhase(hp) {
  if (hp > 600) return 1;
  if (hp > 300) return 2;
  return 3;
}
function getFirstLivingHeroIndex(heroes) {
  return heroes.findIndex((h) => h.hp > 0);
}
function tickCooldowns(heroes) {
...
function applyHeroAbility(state, heroIndex, abilityId) {
  let s = { ...state };
...
function resolveVillainTurn(state) {
  var _a2;
  let s = { ...state };
  const villain = { ...s.villain };
  ...
  const livingIndices = heroes.map((h, i) => ({ h, i })).filter(({ h }) => h.hp > 0);
  ...
  const targetEntry = livingIndices.reduce(
    (min, cur) => cur.h.hp < min.h.hp ? cur : min
  );
  ...
  let baseDmg;
  if (phase === 1)
    baseDmg = 35 + Math.floor(Math.random() * 16);
  else if (phase === 2)
    baseDmg = 50 + Math.floor(Math.random() * 21);
  else baseDmg = 70 + Math.floor(Math.random() * 21);
  ...
  let warpMessage = "";
  if (doWarp) {
    const recentBind = s.combatLog.slice(0, 3).some((l) => l.text.includes("warp prevented"));
    if (!recentBind) {
      const warps = [
  ...
  if (((_a2 = heroes[nextActive]) == null ? void 0 : _a2.hp) <= 0) {
    const aliveIdx = getFirstLivingHeroIndex(heroes);
...
function gameReducer(state, action) {
  ...
  switch (action.type) {
    case "SELECT_HERO": {
      if (((_a2 = state.heroes[action.index]) == null ? void 0 : _a2.hp) <= 0) return state;
...
function App() {
  ...
  const [gameState, dispatch] = reactExports.useReducer(
    gameReducer,
    null,
    createInitialState
  );
  const [outcome, setOutcome] = reactExports.useState("win");
  const [abilitiesUsed, setAbilitiesUsed] = reactExports.useState(0);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-dvh w-full overflow-x-hidden font-body", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 min-h-dvh flex flex-col items-center justify-start", children: [
      screen === "intro" && /* @__PURE__ */ jsxRuntimeExports.jsx(IntroScreen, { onStart: handleStart }),
      screen === "battle" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        BattleScreen,
        {
          state: gameState,
          dispatch,
      ...
      screen === "winlose" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        WinLoseScreen,
        {
          outcome,
